        ...
        <div class="container">
            <div class="row">
                ...
                <div id="content" class="col-sm-9  all-blog my-account">
                    ...
                    <div   class="row">
                        <div class="col-sm-6">
                            <form id="createaccountform" class="form-horizontal well">
                                <fieldset  id="account">
                                    <legend style="text-align: center;" ><b>Register Account</b></legend>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" name="email" placeholder="E-Mail"
                                                id="input-email" class="form-control" onclick="removechk()" required>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                ...
                                <fieldset>
                                    <legend style="text-align: center;"><b>Your Password</b></legend>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="password">Password</label>
                                        <div class="col-sm-10">
                                            <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="password" placeholder="Password"
                                                id="password" class="form-control" onclick="removechk()" required>
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label" for="confirmpassword">Password
                                            Confirm</label>
                                        <div class="col-sm-10">
                                            <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" name="confirmpassword"
                                                placeholder="Password Confirm" onclick="removechk()" id="confirmpassword" class="form-control" required>
                                        </div>
                                    </div>
                                ...
                                <div class="buttons clearfix">
                                    <div align="center" class="pull-right">
                                        ...
                                        <!-- <input id="regiterbtn" type="submit" value="Register" class="btn btn-primary"> -->
                                    </div>
                                </div>
                            </form>
                        </div>
