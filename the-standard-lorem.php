...
<!-- Mirrored from html.themability.com/pizzaking/the-standard-lorem.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Aug 2023 05:48:25 GMT -->
<head>
    <meta charset="UTF-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>The Standard Lorem - Pizza HTML Template - PizzaKing</title>
...
<body class="homepage">
                ...
                <div class="pull-left">
                    <form action="#" method="post" enctype="multipart/form-data" id="form-currency">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu currency-dropdown dropdown-menu-right top_dropdown-menu-right">
                                <li>
                            ...
                            <ul class="dropdown-menu language-dropdown dropdown-menu-right">
                                <li>
                                    <button class="btn btn-link btn-block language-select" type="button"
                                        name="en-gb"><img src="assets/images/en-gb.png" alt="English" title="English">
                                        English</button>
                                </li>
                                <li>
                                    <button class="btn btn-link btn-block language-select" type="button" name="ar"><img
                                            src="assets/images/ar.png" alt="Arabic" title="Arabic">
                                        Arabic</button>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container">
            <div class="header-inner">
                <div class="header-left">
                    <div id="logo">
                        <a href="index.html">
                            <img src="assets/images/logo-white.png" title="Your Store" alt="Your Store"
                                                                            ...
                                                                            <div class="row">
                                                                                    ...
                                                                                    <div class="menu">
                                                                                        <ul>
                                                                                            <li><a href="category.html"
                                                                                                    class="main-menu">Pasta</a>
                                                                                                <ul>
                                                                                                    <li><a
                                                                                                            href="category.html">Fedelini</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Lasagna</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Perciatelli</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Rustiche</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Mandala</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Boccoli</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Chifferi</a>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </li>
                                                                                        </ul>
                                                                                ...
                                                                                <div class="col-sm-3 static-menu">
                                                                                    <div class="menu">
                                                                                        <ul>
                                                                                            <li><a href="category.html"
                                                                                                    class="main-menu">french
                                                                                                    fries</a>
                                                                                                <ul>
                                                                                                    <li><a
                                                                                                            href="category.html">Sachets</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Ziti</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Rotelle</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Fregula</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Puntine</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Gnocchi</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Stortini</a>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </li>
                                                                                        </ul>
                                                                                ...
                                                                                <div class="col-sm-3 static-menu">
                                                                                    <div class="menu">
                                                                                        <ul>
                                                                                            <li><a href="category.html"
                                                                                                    class="main-menu">Drink</a>
                                                                                                <ul>
                                                                                                    <li><a
                                                                                                            href="category.html">sosyo</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">coca-cola</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Cheddar
                                                                                                            Cheese</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">green
                                                                                                            papper</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Mushrooms</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Spinach</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">greek</a>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </li>
                                                                                        </ul>
                                                                                ...
                                                                                <div class="col-sm-3 static-menu">
                                                                                    <div class="menu">
                                                                                        <ul>
                                                                                            <li><a href="category.html"
                                                                                                    class="main-menu">salad</a>
                                                                                                <ul>
                                                                                                    <li><a
                                                                                                            href="category.html">Tossed
                                                                                                            Salad</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Taco
                                                                                                            Salad</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Italian
                                                                                                            Salad</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Pepperoni</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Corn
                                                                                                            Chips</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Mozzarella
                                                                                                        </a></li>
                                                                                                    <li><a
                                                                                                            href="category.html">Tomato</a>
                                                                                                    </li>
                                                                                                    <li><a
                                                                                                            href="category.html">Piombi</a>
                                                                                                    </li>
                                                                                                </ul>
                                                                                            </li>
                                                                                        </ul>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="html ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-6">
                                                                                    <div class="link">
                                                                                        <img src="assets/images/megamenu/2.jpg"
                                                                                            alt=""
                                                                                            class="img-responsive">
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <div class="row sub_sub_menu">
                                                                    <div class="col-sm-4">
                                                                        <div class="megamenu-product-list">
                                                                            <span class="title-submenu">Special
                                                                                Product</span>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 ">
                                                                        ...
                                                                        <ul class="subcategory ">
                                                                            <li>
                                                                                <a href="category.html"
                                                                                    class="title-submenu">donuts</a>
                                                                                <div class="row sub_sub_menu">
                                                                                    <div class="col-sm-12 hover-menu">
                                                                                        <div class="menu">
                                                                                            <ul>
                                                                                                <li><a href="category.html"
                                                                                                        class="main-menu">Glazed</a>
                                                                                                </li>
                                                                                                <li><a href="category.html"
                                                                                                        class="main-menu">Jelly</a>
                                                                                                </li>
                                                                                                <li><a href="category.html"
                                                                                                        class="main-menu">Sour
                                                                                                        Cream</a></li>
                                                                                                <li><a href="category.html"
                                                                                                        class="main-menu">Sprinkled</a>
                                                                                                </li>
                                                                                                <li><a href="category.html"
                                                                                ...
                                                                                <img src="assets/images/banners/category_banner1.jpg"
                                                        ...
                                                        <div class="sub-menu">
                                                            <div class="content">
                                                                <div class="row">
                                                                    <div class="col-sm-4">
                                                                        <div class="megamenu-product-list">
                                                                            <span class="title-submenu">Popular
                                                                                Product</span>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 ">
                                                                                    <div class="menu-product-thumb">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="caption">
                                                                                                <h4><a
                                                                                                        href="product.html">Margherita</a>
                                                                                                </h4>
                                                                                                <div class="rating">
                                                                                                    <span
                                                                                                        class="fa fa-stack"><i
                                                                                ...
                                                                                <div class="col-sm-12 ">
                                                                                    <div class="menu-product-thumb">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="caption">
                                                                                                <h4><a
                                                                                                        href="product.html">Buttercrust</a>
                                                                                                </h4>
                                                                                                <div class="rating">
                                                                                                    <span
                                                                                                        class="fa fa-stack"><i
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="megamenu-product-list">
                                                                            <span class="title-submenu">Bestseller
                                                                                Product</span>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 ">
                                                                                    <div class="menu-product-thumb">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <div class="megamenu-product-list">
                                                                            <span class="title-submenu">Latest
                                                                                Product</span>
                                                                            <div class="row">
                                                                                <div class="col-sm-12 ">
                                                                                    <div class="menu-product-thumb">
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="caption">
                                                                                                <h4><a
                                                                                                        href="product.html">PeppiPizza</a>
                                                                                                </h4>
                                                                                                <div class="rating">
                                                                                                    <span
                                                                                                        class="fa fa-stack"><i
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center product-cart-thumb">
                                                    <a href="#">
                                                        <img src="assets/images/products/11.jpg" alt="veggie delight"
                                                            title="veggie delight" class="img-thumbnail">
                                                    </a>
                                                </td>
                                                <td class="text-left product-cart-details">
                                                    <a href="#" class="product-item-name">Veggie Delight</a>
                                                    <br>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-left product-cart-details">
                                                    <a href="#" class="product-item-name">PeppiPizza</a>
                                                    <div class="product-cart-info">
                                                        <span class="product-cart-qty">1 x </span>
                                                        <span class="product-cart-price">$241.99</span>
                                                    </div>
                                                </td>
                                                <td class="text-center product-cart-close">
                                                    <button type="button" title="Remove"
                                ...
                                <li>
                                    <div>
                                        ...
                                        <p class="text-right product-cart-button">
                                            <a href="shopping-cart.html" class="btn cart-btn addtocart-btn"><i
                        ...
                        <div class="box-category">
                            ...
                            <ul class="list-unstyled parent" id="select-category">
                                <li class="has-more-category">
                                    <a href="category.html" class="list-group-item main-item">Drink<span
                                            class="toggled"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <ul class="list-unstyled child-categories group">
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; coca-cola</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; sosyo</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-more-category">
                                    <a href="category.html" class="list-group-item main-item">salad<span
                                            class="toggled"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <ul class="list-unstyled child-categories group">
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Taco Salad</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Tossed
                                                Salad</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Italian
                                                Salad</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-more-category">
                                    <a href="category.html" class="list-group-item main-item">donuts<span
                                            class="toggled"><i class="fa fa-plus"></i></span>
                                    </a>
                                    <ul class="list-unstyled child-categories group">
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Glazed</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Jelly</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Sour Cream</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; Sprinkled</a>
                                        </li>
                                        <li>
                                            <a href="category.html" class="list-group-item">&nbsp;&nbsp; suop</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="">
                                    <a href="category.html" class="list-group-item ">Pizza<span></span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="category.html" class="list-group-item ">french fries<span></span></a>
                                </li>
                                <li class="">
                                    <a href="category.html" class="list-group-item ">hotdog<span></span></a>
                                </li>
                                <li class="">
                                    <a href="category.html" class="list-group-item ">burger<span></span></a>
                                </li>
                                <li class="has-more-category">
                ...
                <div id="content" class="col-sm-9  all-blog">
                    <div class="breadcrumb-main">
                        <div class="breadcrumb-container clearfix">
                            <h1 class="page-title">The Standard Lorem</h1>
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">The Standard Lorem</a>
                                </li>
                    ...
                    <div class="article-blog">
                        ...
                        <div class="blog-image">
                            <img src="assets/images/blog/3.png" alt="The Standard Lorem" title="The Standard Lorem"
                                class="img-responsive">
                        </div>
                        <div class="blog-description">
                            ...
                            <div class="blog_title">The Standard Lorem</div>
                        ...
                        <div class="view-comment">
                            <div class="view-comment-inner">
                                ...
                                <div class="comment_info">
                                    ...
                                    <div class="name">12/08/2021</div>
                                    <div class="comment-text">Provides Constructive Criticism</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer>
        <div class="container">
            ...
            <!-- <hr> -->
            <p class="copyright"><a href="#"></a>© 2022 Pizzaking - All Rights Reserved.</p>
        </div>
    </footer>
