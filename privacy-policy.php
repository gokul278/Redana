...
<head>
	...
	<title>Privacy Policy - Redana</title>
						...
						<table class="table table-striped">
							<tbody>
								...
								<tr>
									<td class="text-center product-cart-thumb">
										<a href="#">
											<img src="assets/images/hotels/briyani/chicken briyani.png" alt="Briyani" title="Briyani" class="img-thumbnail">
										</a>
									</td>
									<td class="text-left product-cart-details">
			...
			<div class="row">
				...
				<div id="content" class="col-sm-9  all-blog">
					...
					<div class="information-information">
						<hr>
						<h2 class="title"><strong>INFORMATION WE COLLECT</strong></h2>
						<p style="color: black;" class="description">
							At<strong> Redana</strong> , we are committed to protecting your privacy and ensuring the security of your personal information. When you use our food ordering and management services,
							 we may collect certain data such as your name, contact information, and order history, solely for the purpose of facilitating your food orders and enhancing your user experience. 
							 We do not share this information with third parties without your explicit consent, except as required by law or to fulfill your orders. We employ robust security measures to safeguard your data, 
							 and you have the right to access, correct, or delete your personal information at any time. By using our services, you consent to the terms outlined in this privacy policy, which reflects our dedication to maintaining the utmost confidentiality and integrity of your data.
							</p>
					</div>
				</div>
			</div>
