			...
			<div class="row">
				...
				<div id="content" class="col-sm-9  all-blog">
					...
					<div class="category-row row">
						...
						$categorysql = "SELECT DISTINCT food_menu.vendor_id, vendorlogin.image, vendorlogin.name, vendorlogin.address
						FROM food_menu
						JOIN vendorlogin ON food_menu.vendor_id = vendorlogin.vendor_id
						WHERE food_menu.cuisines Like '%{$_GET['item']}'";
									...
									<div class='product-description'>
										<div style='text-align: center;' class='caption'>
											<div class='title-rating clearfix'>
												<h3 class='product-title'><a href='product.php'>{$categoryrow['name']}</a>
												</h3>
											</div>
											<div class='title-rating clearfix'>
												<h6 class='product-title'>From</a>
												</h6>
											</div>
											<div class='title-rating clearfix'>
												<h4 class='product-title'><a href='product.php'>{$categoryrow['address']}</a>
												</h4>
											</div>
										</div>
									</div>
